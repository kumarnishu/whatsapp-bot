    ...
    return (
        ...
        >
            <div style={{ height: "90vh" }}>
                ...
                >
                    ...
                    <Panel position="top-right" className="d-flex flex-column gap-1">
                        ...
                        >
                            ...
                            >
                                <img width="20" height="20" src="https://img.icons8.com/glyph-neue/64/bookmark-ribbon.png" alt="undo" />
                                <span >Save</span>
                            </div>
                        </div>
                        <div style={{ cursor: "pointer", maxWidth: 100, backgroundColor: '#72A0C1' }} className="react-flow__node-default btn p-1 fs-6 mt-1 text-light"
                ...
                {displaySaveModal && flow ? <SaveFlowModal flow={flow} setDisplaySaveModal={setDisplaySaveModal} /> : null}
            </div>
        </Modal>
    )
}
