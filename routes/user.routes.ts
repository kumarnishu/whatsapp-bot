...
import { GetProfile, GetUsers, Login, Logout, ResetPassword, SendPasswordResetMail, SendVerifyEmail, SignUp, UpdateProfile, VerifyEmail, updatePassword } from "../controllers/user.controller";
